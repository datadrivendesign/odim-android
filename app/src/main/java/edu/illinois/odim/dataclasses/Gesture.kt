...
data class Gesture(
    ...
    constructor(eventClassName: String) : this(centerX=-1F, centerY=-1F, scrollDX=-1F,scrollDY= -1F, type=null, viewId= null) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return this.centerX == otherGesture?.centerX &&
                ...
                this.type == otherGesture.type &&
                this.viewId == otherGesture.viewId &&
                this.scrollDY == otherGesture.scrollDY
    }

    override fun toString(): String {
        return "$centerX, $centerY, $scrollDX, $scrollDY, $viewId, $type, $className, $verified"
    }
